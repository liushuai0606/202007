...
def qytang_ssh(ip, username, password , cmd='ls'):
    import paramiko
...
if __name__ == '__main__':
    print(qytang_ssh('192.168.1.120','root','Kd2@@456'))
    print(qytang_ssh('192.168.1.120','root','Kd2@@456',cmd='pwd'))
    print('网关为：')
    print(ssh_get_route('192.168.1.120', 'root', 'Kd2@@456'))